...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Water Parks</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/water parks.jpg" alt="">
            <p>
                Water parks want to offer the most attractive, exciting, and appealing rides. Ideally, a water park has attractions ranging from Thrill rides to family slides to kids play area making it popular amongst people of all ages and walks of life.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Water Parks'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Water Parks Community</button>
              </div>
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
    ...
    $sql = "SELECT * FROM geolocation where activity='Water Parks' and mylocation='Chennai'";
...
<div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Water Parks'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Water Parks'";
