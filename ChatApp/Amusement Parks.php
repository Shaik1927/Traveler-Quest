    ...
    <div class="container">
        <div class="row justify-content-start mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate">
                <span class="subheading">Categeory</span>
                <h2 class="mb-4">Adventures in <strong> Amusement Parks</strong></h2>
            </div>
        </div>
        <div class="row">
    <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Amusement Parks'";
