...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Wakeboarding</strong></h2>
            </div>
            <div class="trek">
                <img src="images/wakeboarding.jpg" alt="">
                <p>
                    Wakeboarding is an extreme sport performed on water. The rider is fastened to a board and towed behind a motorboat at speeds of around 50 km per hour.Wakeboarding is an extreme sport performed on water. The rider is fastened to a board and towed behind a motorboat at speeds of around 50 km per hour.</p>
            </div>
            <div class="form-group"  style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Wakeboarding'">
    ...
    $sql = "SELECT * FROM geolocation where activity='Wakeboarding' and mylocation='Chennai'";
    ...
    ?>
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Wakeboarding'";
    ...
    ?>
            ...
            <section class="ftco-section">
                <div class="container">
                    ...
                    <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Wakeboarding'";
