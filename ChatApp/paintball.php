...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Paint Ball</strong></h2>
            </div>
            <div class="trek">
                <img src="images/paintball.jpg" alt="">
                <p>
                    Paint Ball is an extreme sport performed on water. The rider is fastened to a board and towed behind a motorboat at speeds of around 50 km per hour.</p>
            </div>
            <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Paint Ball'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Paint Ball Community</button>
            </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Paint Ball' and mylocation='Chennai'";
    ...
    ?>
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Paint Ball'";
    ...
    ?>
        ...
        <section id="adventure" class="section-p1">
            <div class="adv-container">
                ...
                <div class="adv">
                    <a href="#"><img src="parasail.jpg" alt="" onclick="window.location.href='Parasailing.html'"></a>
                    <h6>Parasaiding</h6>
                </div>
                <div class="adv">
                    <a href="#"><img src="surf.jpg" alt="" onclick="window.location.href='Surfing.html'"></a>
                    <h6>Surfing</h6>
                </div>
                <div class="adv">
                    <a href="#"><img src="paramotor.jpg" alt="" onclick="window.location.href='Paramotoring.html'"></a>
                    <h6>Paramotoring</h6>
                </div>
                 </div> 
        </section>
            ...
            <section class="ftco-section">
                <div class="container">
                    ...
                    <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Paint Ball'";
