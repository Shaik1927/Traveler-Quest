...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>River Rafting</strong></h2>
        </div>

        <div class="trek">
        <img src="images/river rafting.jpg" alt="">
            <p>
            Rafting and whitewater rafting are outdoor entertainment activities that use a boat or an unsinkable raft. It has different difficulty levels according to the current of the water in which the sport is done. It can be done solo but is more commonly done
                with group and needs good teamwork to manage the water.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=River Rafting'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join River Rafting Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='River Rafting' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1">
           
            <div class="trek2">
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='River Rafting'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='River Rafting'";
