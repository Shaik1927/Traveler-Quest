...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Paragliding</strong></h2>
            </div>
        
        <div class="trek">
            <img src="images/paragliding.jpg" alt="">
            <p>
                This early form of the activity was designed to train individuals in parachute control and safe landings. Using a car was a much more economical solution than using a plane multiple times.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Paragliding'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Paragliding Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Paragliding' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Paragliding'";
