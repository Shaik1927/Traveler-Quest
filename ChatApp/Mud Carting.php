...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        ...
        <div class="trek">
            <img src="images/mud cart.jpg" alt="">
        ...
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Mud Carting'">
    ...
    $sql = "SELECT * FROM geolocation where activity='Mud Carting' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Mud Carting'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Mud Carting'";
