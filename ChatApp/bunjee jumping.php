...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>Bunjee jumping</strong></h2>
        </div>

        <div class="trek">
            <img src="images/bunjee jumping.jpg" alt="">
            <p>
            Bungee jumping is an action-filled recreational activity that involves head-first jumping from a tall structure with an elastic cord attached into participants' feet. That tall structure can be a building, crane, bridge or even a helicopter.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Bunjee Jumping'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Bunjee jumping Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Bunjee Jumping' and mylocation='Chennai'";
    ...
    ?>
            ...
            if ($result4->num_rows) {
                ...
                echo 'No Adventures found in the locality.';
            }
            ?>
        </div>
    </div>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Bunjee Jumping'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Bunjee Jumping'";
