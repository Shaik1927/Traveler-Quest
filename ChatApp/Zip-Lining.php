...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>Zip-Lining</strong></h2>
        </div>

        <div class="trek">
            <img src="images/Zip-Lining.jpg" alt="">
            <p>
        ...
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Zip-Lining'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Zip-Lining Community</button>
        </div>
...
<section class="ftco-section services-section bg-light">
    ...
    $sql = "SELECT * FROM geolocation where activity='Zip-Lining' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Zip-Lining'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Zip-Lining'";
