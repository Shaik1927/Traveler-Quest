...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>Helicopter Ride</strong></h2>
        </div>

        <div class="trek">
            <img src="images/helicopter ride.jpg" alt="">
            <p>
You can feel almost every little maneuver the pilot makes, and you are much closer to the ground, so the views are spectacular. On the other hand, flying in an airplane is a much more smooth experience. The plane is flying much higher, so you don't feel any turbulence and the view is more distant.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Helicopter Ride'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Helicopter Ride Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Helicopter Ride' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Helicopter Ride'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Helicopter Ride'";
