...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="trek1" style="text-align: center;">Hot Air Ballon</div>
        <div class="trek">
            <img src="images/hot air ballon.jpg" alt="">
            <p>
                Horseback riding is a recreational and therapeutic activity enjoyed by individuals of all ages and abilities. As a sport, it provides the rider with the opportunity to master the skills necessary to confidently control and steer the horse through various
                patterns and obstacles.</p>
        </div>
        <div class="form-group"  style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Hot Air Balloon'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Wakeboarding Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Hot Air Balloon' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Hot Air Balloon'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Hot Air Balloon'";
