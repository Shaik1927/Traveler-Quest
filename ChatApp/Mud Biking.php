...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Mud Biking</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Mud Biking</div> -->
        <div class="trek">
            <img src="images/mud bike.jpg" alt="">
            <p>
            Mud bike touring is the taking of self-contained cycling trips for pleasure, adventure or autonomy rather than sport, commuting or exercise. Bike touring can range from single-day trips to extended travels spanning weeks or months.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Mud Biking'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Mud Biking Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Mud Biking' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Mud Biking'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Mud Biking'";
