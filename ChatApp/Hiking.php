...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Hiking</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Trekking</div> -->
        <div class="trek">
            <img src="images/hiking.jpg" alt="">
            <p>People often confuse trekking, hiking, and trail walking. There is a subtle yet significant difference. While all three activities involve walking, trekking is usually undertaken for more than a day, which is why it is sometimes referred to as backpacking. Hiking, on the other hand, is generally a day-long trip.</p>
        </div>
        
    </section>
    <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Hiking'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Hiking Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Hiking' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            <!-- <div class="trek1" style="text-align: center;">ITEMS FOR ADVENTURE</div> -->
            <div class="trek2">
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Hiking'";
...
<section class="ftco-section">
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Hiking'";
