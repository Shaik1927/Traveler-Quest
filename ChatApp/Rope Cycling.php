...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Rope Cycling</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/Rope cycle.jpg" alt="">
            <p>
            Many communities and cultures live here. This diversity is also seen in wildlife around the country. A jungle Rope Cycling is the closest way of experiencing the wildlife of India. So, if you are looking for an adventure trip, read on to know the best places
                to experience Jungle Rope Cycling.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Rope Cycling'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Rope Cycling Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Rope Cycling' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Rope Cycling'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Rock Climbing'";
