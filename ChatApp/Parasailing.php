...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>Parasailing</strong></h2>
        </div>

        <div class="trek">
            <img src="images/parassailing.jpg" alt="">
            <p>
                A steerable glider with inflatable wings proposed for use as an emergency vehicle for travel between a space station and the earth or for the recovery of rocket boosters. A person who engages in parasailing.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Parasailing'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Parasailing Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Parasailing' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Parasailing'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Paragliding'";
