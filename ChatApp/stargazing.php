...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>stargazing</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/stargazing.jpg" alt="">
            <p>
            Many communities and cultures live here. This diversity is also seen in wildlife around the country. A jungle stargazing is the closest way of experiencing the wildlife of India. So, if you are looking for an adventure trip, read on to know the best places
                to experience Jungle stargazing in desert.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=stargazing'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join stargazing Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='stargazing' and mylocation='Chennai'";
    ...
    ?>
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='stargazing'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Stargazing'";
