...
?>
    ...
    <section id="trekking" class="section-p1" style="margin-top:60px;">
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <h2 class="mb-4"><strong>Glass Bridge</strong></h2>
        </div>

        <div class="trek">
            <img src="images/glass bridg.jpg" alt="">
            <p>
        ...
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Glass Bridge'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Glass Bridge Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Glass Bridge' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Glass Bridge'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Glass Bridge'";
