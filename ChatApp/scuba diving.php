...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Scuba Diving</strong></h2>
            </div>
        
        <div class="trek">
            <img src="images/scuba diving.jpg" alt="">
            <p>
                scuba diving is a water sport that involves breathing air from a tank while underwater. Scuba is an acronym for Self Contained Underwater Breathing Apparatus. Most scuba divers are recreational divers who explore underwater environments such as lakes,
                rivers, quarries, kelp forests and coral reefs.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Scuba Diving'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Scuba Diving Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Scuba Diving' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Scuba Diving'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Scuba Diving'";
