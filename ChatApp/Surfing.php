...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Surfing</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/surfing.jpg" alt="">
            <p>
                Surfing is one of the most popular and most preferred extreme sports in the world. It is done by riding the waves in the sea or the ocean by standing or lying on a surfboard.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Surfing'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Surfing Community</button>
              </div>

              <section class="ftco-section services-section bg-light" style="margin-left:9%">
    <div class="container">
        <div class="row2 d-flex">

        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM geolocation where activity='Surfing' and mylocation='Chennai'";
    ...
    ?>
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Surfing'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Surfing'";
