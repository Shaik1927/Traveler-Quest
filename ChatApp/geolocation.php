...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            ...
            <div>
                <h1> location data base </h1>
            </div>
            <form action="geolocationbk.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <input type="mylocation" name="mylocation" placeholder="My location" required>
                </div>
