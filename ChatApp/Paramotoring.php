...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Paramotoring</strong></h2>
            </div>
        <div class="trek">
            <img src="images/paramotoring.jpg" alt="">
            <p>
                The sport of flying through the air wearing a piece of equipment consisting of a motor connected to a parachute. they introduced me to the sport of paramotoring on the top of a hill in the powered paragliding.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Paramotoring'">
            <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Paramotoring Community</button>
        </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Paramotoring' and mylocation='Chennai'";
    ...
    ?>
        ...
        <section id="trekking1" class="section-p1" style="margin-left:9%">
            ...
            <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Paramotoring'";
    ...
    ?>
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Paramotoring'";
