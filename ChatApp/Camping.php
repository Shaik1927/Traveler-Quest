...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Camping</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/camping.jpg" alt="">
            <p>
                Camping is one of the most popular and most preferred extreme sports in the world. It is done by riding the waves in the sea or the ocean by standing or lying on a surfboard.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Camping'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Camping Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Camping' and mylocation='Chennai'";
    ...
    ?>
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Camping'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Camping'";
