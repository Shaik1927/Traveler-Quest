...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Safari</strong></h2>
            </div>
        
        <div class="trek">
            <img src="images/safari.jpg" alt="">
            <p>
            Many communities and cultures live here. This diversity is also seen in wildlife around the country. A jungle safari is the closest way of experiencing the wildlife of India. So, if you are looking for an adventure trip, read on to know the best places
                to experience Jungle Safari.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Safari'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Safari Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Safari' and mylocation='Chennai'";
    ...
    ?>
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Safari'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Safari'";
