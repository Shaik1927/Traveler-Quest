...
?>
    ...
    <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
                ...
                <h2 class="mb-4"><strong>Glacial-Exploring</strong></h2>
            </div>
        <!-- <div class="trek1" style="text-align: center;">Bike Trip</div> -->
        <div class="trek">
            <img src="images/glacialll.jpg" alt="">
            <p>
            Exploring the glaciers in Iceland is a one-of-a-kind experience. There are many great glaciers in Iceland, where you can hike, climb or go under. This is something we fully recommend.Many alpine rock climbs can only be accessed by travelling across glaciers, or the glacier itself may be the best route to an alluring summit.</p>
        </div>
        <div class="form-group" style="margin-left:18%;margin-bottom:150px;margin-top:0;" onclick="window.location.href='mycommunity.php?activity=Glacial-Exploring'">
                <button type="button" style="margin-left:28%" class="btn btn-primary py-3 px-5">Join Glacial-Exploring Community</button>
              </div>
    ...
    $sql = "SELECT * FROM geolocation where activity='Glacial-Exploring' and mylocation='Chennai'";
    ...
    ?>
        ...
        <div class="col-md-7 heading-section ftco-animate" style="margin-left:9%">
            ...
            <section id="trekking1" class="section-p1" style="margin-left:9%">
                ...
                <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM ckeditor where activity='Glacial-Exploring'";
    ...
    <div class="container">
        ...
        <?php
    // Query to select all images from the table
    $sql = "SELECT * FROM activities where categeory='Glacial Exploration'";
